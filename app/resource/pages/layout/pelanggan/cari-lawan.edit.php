...
<?php include __DIR__ . "/../../components/navbar-top-pelanggan.php" ?>
    ...
    <section class="pt-100px px-3">
        <div class="container">
            <div class="row">
                <h1 class="font-size-2-0rem pt-sans-bold text-center text-black py-3">Edit Cari Lawan</h1>
            </div>
            <form method="POST">
                <div class="row">
                    ...
                    <div class="col-4 mb-3">
                        <label class="form-label font-size-1-2em pt-sans-bold">Waktu</label>
                        <select class="form-select w-100 pt-sans-bold" aria-label="Pilih Jam">
                    ...
                    <div class="col-12">
                        <button type="submit" class="btn btn-lg text-white bg-two w-100 border-0 font-size-1-2em pt-sans-bold mt-4">Simpan Perubahan</button>
                    </div>
                    <div class="col-12">
                        <button type="submit" class="btn btn-lg text-white bg-danger w-100 border-0 font-size-1-2em pt-sans-bold mt-3 mb-5">Hapus</button>
                    </div>
                </div>
            </form>
        </div>
