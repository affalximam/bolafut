...
<body class="bg-one">
    ...
    <section class="event mt-5 pt-5 pb-5 mb-5 ts-1-0s">
        <div class="container ps-0">
            <div class="row px-5">
                <?php for($i = 1; $i < 10; $i++) : ?>
                <div class="col-xl-6">
                    <a href="/event-detail/<?= $i; ?>"
                        class="card w-100 mb-4 border-0 px-3 py-3 pt-sans-bold rounded rounded-2 text-decoration-none">
                        <div class="row">
                            <h1 class="pt-sans-bold font-size-1-5em">Lapangan Futsal <?= $i; ?></h1>
                            <h2 class="pt-sans-bold font-size-1-3em">1-11-2024 (21.30)</h2>
                            <img src="/assets/images/141428_wo 1.png" class="w-100">
                            <pre class="d-inline font-size-1-0em pt-sans-bold w-100 overflow-hidden text-justify pt-2">
