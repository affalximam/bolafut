                ...
                <form method="POST">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <input type="text" name="booking_name" class="form-control w-100 border-none input-lg" required>
                        </div>
                    </div>
                    <div class="row pt-3">
                        <div class="col-4 mb-3">
                            <label class="form-label font-size-1-2em pt-sans-bold">Tahun</label>
                            <select class="form-select w-100 pt-sans-bold" name="booking_year" aria-label="Pilih Tahun" required>
                        ...
                        <div class="col-4 mb-3">
                            ...
                            <select class="form-select w-100 pt-sans-bold" aria-label="Pilih Bulan" name="booking_month" id="bulan" onchange="updateDays()" required>
                        ...
                        <div class="col-4 mb-3">
                            ...
                            <select class="form-select w-100 pt-sans-bold" aria-label="Pilih Tanggal" name="booking_day" id="tanggal" required>
                        ...
                        <div class="col-4 mb-3">
                            ...
                            <select id="booking-time" class="form-select w-100 pt-sans-bold" aria-label="Pilih Jam Mulai" name="booking_hours" required>
                                <option value="" selected disabled>Pilih Jam Mulai</option>
                                <?php for ($i = $openHour; $i < $closeHour; $i++): ?>
                        ...
                        <div class="col-4 mb-3">
                            ...
                            <select id="booking-duration" class="form-select w-100 pt-sans-bold" aria-label="Pilih Durasi" name="booking_duration" required>
                                <option value="" selected disabled>Pilih Durasi</option>
                            </select>
                        </div>
                        <div class="col-12">
                            <button type="submit" name="booking_add" class="btn btn-lg text-white bg-two w-100 border-0 font-size-1-2em pt-sans-bold my-4">Booking</button>
                        </div>
                    </div>
                </form>
