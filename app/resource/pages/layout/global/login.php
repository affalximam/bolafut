...
<!-- @include(__DIR__ . "/../../components/navbar-global.php"); -->
            ...
            <div class="container">
                <form method="POST">
                    <div class="my-2 w-75 mx-auto text-center">
                        <label for="exampleInputWhatsapp" class="form-label text-blue-303D57 font-size-1-3rem pt-sans-bold">Nomor Whatsapp atau Email</label>
                        <input type="text" name="username" class="d-block p-2 w-100 border-4 rounded rounded-3 border-color-303D57 text-blue-303D57 font-size-1-3rem pt-sans-bold no-spinners" id="exampleInputWhatsapp">
                    </div>
                    <div class="my-2 w-75 mx-auto text-center">
                        <label for="exampleInputPassword" class="form-label text-blue-303D57 font-size-1-3rem pt-sans-bold">Password</label>
                        <input type="password" name="password" class="d-block p-2 w-100 border-4 rounded rounded-3 border-color-303D57 text-blue-303D57 font-size-1-3rem pt-sans-bold" id="exampleInputPassword">
                    </div>
                    <div class="row pt-3">
                        <div class="col-xl-6 offset-xl-3 col-8 offset-2">
                            <button type="submit" name="login" class="w-100 py-2 rounded rounded-4 bg-two text-blue-DBE9F4 font-size-1-3rem pt-sans-bold">LOGIN</button>
                        </div>
                    </div>
                </form>
            </div>
        </div>
        <div class="register-form min-w-100vw pb-5 mb-5">
            <div class="container">
                <form method="POST">
                    <div class="row">
